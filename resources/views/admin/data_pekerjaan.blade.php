            ...
            <tr>
                ...
                <td>
                    <form action="/admin/pekerjaan/delete/{{$data->id}}" method="POST">
                        @csrf
                        @method('DELETE')
                        <a href="/admin/pekerjaan/edit/{{$data->id}}" class="btn btn-outline-primary"><i class="bi bi-pencil-fill"></i> Edit</a>
                        <button href="#" class="btn btn-outline-danger"><i class="bi bi-trash3-fill"></i> Delete</button>
                    </form>
                </td>
                @endforeach
            </tr>
