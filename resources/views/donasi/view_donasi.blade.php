    ...
    <div class="container min-vh-100 py-5">
        <div class="row d-flex">
            ...
            <div class="col text-end">
                ...
                <i class="bi bi-search subtitle utama"></i>
                <a href="/donasi/berhasil" class="icon-utama"><i class="bi bi-filter subtitle"></i></a>
                <a href="riwayat" class="icon-utama"><i class="bi bi-clock-history subtitle"></i></a>
                <a href="/donasi/create" class="btn btn-sekunder mb-4 ms-4">
                    <h4>Buat Donasi</h4>
                </a>
                @endif
            </div>
                ...
                <a href="/donasi/{{$d->id}}" class="text-decoration-none">
                    <div class="card border-0">
                        <table>
                            <tr>
                                <td class="pe-3">
                                    <h2 class="fw-bold utama text-start">{{$loop->iteration }}</h2>
                                </td>
                                <td class="text-start">
                                    <h6>Donasi {{$d -> nama_donasi}}</h6>
                                    <i class="bi bi-pin-map-fill utama"></i> <b
                                        class="segera-lokasi">{{$d -> lokasi}}</b>
                                </td>
                            </tr>
                        </table>
                    </div>
